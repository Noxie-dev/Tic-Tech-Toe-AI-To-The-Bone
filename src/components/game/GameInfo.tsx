...
const GameInfo: FC<GameInfoProps> = ({ timer, formatTime, scores, gameMode }) => {
  return (
    <div className="flex flex-col space-y-4 mb-6">
      {/* Timer and Draw in a single row */}
      <div className="grid grid-cols-2 gap-2" aria-label="Game timer and draws">
        <div className="flex justify-between items-center px-4 py-3 bg-gray-800/70 backdrop-blur-sm rounded-lg border border-gray-700/50 shadow-inner shadow-gray-900/80"
        ...
        <div className="flex justify-between items-center px-4 py-3 bg-gray-800/40 backdrop-blur-sm rounded-lg border border-gray-700/30 transition-all duration-300 hover:bg-gray-800/50"
